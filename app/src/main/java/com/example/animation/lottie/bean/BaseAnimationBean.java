 ...
 * Desc:
 * Author: JS-Kylo
 * Created On: 2019/10/31 11:38
 */
public class BaseAnimationBean implements AnimationIdentify,Cloneable {
      /** 用户id
     */
    ...
    public BaseAnimationBean(int userId, int giftId, String userName, String giftName, String giftImg, long time) {
        this.userId = userId;
        this.giftId = giftId;
    ...
    @Override
    public int compareTo(AnimationIdentify o) {
