 ...
 * Desc:
 * Author: JS-Kylo
 * Created On: 2019/10/31 13:17
 */
public class AnimationQueue {
    private String TAG = "GiftBasket";

    BlockingQueue<AnimationIdentify> queue = new LinkedBlockingQueue<>();
     ...
     * @param bean
     */
    public void putGift(AnimationIdentify bean) throws InterruptedException {
...
//        queue.offer(bean,5, TimeUnit.SECONDS);
     ...
     * @return
     */
    public AnimationIdentify takeGift() throws InterruptedException {
        //检索并移除队列头部元素，如果队列为空,线程进入等待，直到有新的数据加入继续消费
        AnimationIdentify bean = queue.take();
